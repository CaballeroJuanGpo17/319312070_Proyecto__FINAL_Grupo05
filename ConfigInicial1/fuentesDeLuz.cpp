...
int main()
{
	...
	Model Casa((char*)"CASALOUD/LoudHouse.obj");
	//MODELOS DE CUARTO Linconl -NOTA: los cojines ya estan en la cama
	//Model conejo((char*)"BUNBUN/BUNBUN.obj");
	//Model Linconl((char*)"CAMALINCONL/CamaLinconl.obj");
	//Model libro((char*)"LIBRO/Hieroglyph_Symbol_0520162300_texture.obj");
	//Model repisa((char*)"REPISA/Wooden_Shelf_0520161332_texture.obj");
	// 
	// MODELOS DE CUARTO Lynn Jr
	//Model Lynn((char*)"CAMALYNNJR/CamaLynnjr.obj");
	//Model Buro((char*)"BURO/Cabinet_Illustration_0519004733_texture.obj");
	//Model BalonA((char*)"AMERICANO/Football_on_Grass_0520160413_texture.obj");
    //Model Futbol((char*)"FUTBOL/Soccer_Ball_Sketch_0520155459_texture.obj");
    //Model reloj((char*)"RELOJ/Flying_Fish_Emblem_0519003735_texture.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Linconl.Draw(lightingShader);
		//libro.Draw(lightingShader);
		//repisa.Draw(lightingShader);
		//Lynn.Draw(lightingShader);
		//Buro.Draw(lightingShader);
		//BalonA.Draw(lightingShader);
		//Futbol.Draw(lightingShader);
